...
CREATE TABLE `Comment` (
  `postCommentID` char(8) NOT NULL,
  `content` text,
  `postID` char(8) DEFAULT NULL,
  `targenCommentID` char(8) DEFAULT NULL,
  `userID` char(8) DEFAULT NULL,
...
CREATE TABLE `Follow` (
  `userID` char(8) DEFAULT NULL,
  `followerID` char(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Message` (
  ...
  `senderID` char(8) DEFAULT NULL,
  `receiverID` char(8) DEFAULT NULL,
...
CREATE TABLE `Post` (
  ...
  `postContent` text,
  `posterID` varchar(8) DEFAULT NULL,
...
CREATE TABLE `Report` (
  ...
  `adminID` char(8) DEFAULT NULL,
  `reply` text,
  `reporteeID` char(8) DEFAULT NULL,
  `reporterID` char(8) DEFAULT NULL,
...
-- Dump completed on 2020-12-09 17:57:14
